...
exports.firstChat = (a, b, c) =>{
	return`Selamat ${a} ${b} 🤗, saya adalah ${c} yaitu bot whatsapp yang dibuat oleh:                                                     Addia Fa'adihilah M.N(02),                                                      Ahmad Bagus Rafi'i(5),                                                                                     Ardi Widiyatmoko(10),                                                                                     Aria Swasti Dewa(11),                                                                                      Faza Maula(15) X PPLG 1.                                                                                  Ada yang bisa ${c} bantu?`
	}
exports.StartAbsen = () =>{
	return`Mulai Absen`
	}
